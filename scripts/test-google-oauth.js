    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes("Invalid login credentials")) {
          console.log("\n💡 Possíveis soluções:");
          console.log("1. Verificar se o Google OAuth está habilitado no Supabase Dashboard");
          console.log("2. Verificar se as credenciais do Google estão corretas");
          console.log("3. Verificar se o redirectTo está configurado corretamente");
          console.log("4. Verificar se o domínio está autorizado no Google Console");
        }
      } else {
